...
// عشان تضيف الصور: حط الـ 4 صور في مجلد public/images
...
export default function GallerySection() {
  ...
  const placeholders = ['♥', '✦', '☾', '♡']
  const captions = [
    'ابتسامتك دي لوحدها تنسيني الدنيا كلها',
    'في عينيكي يا ملك بشوف كل حاجة حلوة في الدنيا',
    'لحظة معنديش استعداد أنساها أبداً',
    'ملاكي.. وأحلى حاجة حصلتلي في حياتي كلها',
  ]
