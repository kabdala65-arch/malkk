    ...
    <section className="promise-section">
      ...
      >
        ...
        <p className="promise-text">
          أوعدك يا ملك إني هفضل زي ما إنتي عارفاني، اللي بيحبك وملوش غيرك،
          وهفضل جنبك في كل حاجة، سندك وضهرك، والكتف اللي تريّحي عليها دماغك ♥
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="poem-text">
          هفضل أحبك بنفس الشكل ده يا ملك، مش أكتر ومش أقل<br />
          ...
          هفضل بحبك بطريقتي، وبشكلي اللي إنتي متعوّدة عليه<br />
          وهفضل حاسس إني محظوظ إن ربنا بعتلي ملاك اسمها ملك ♥♥♥
        </p>
      </motion.div>
    </section>
  )
